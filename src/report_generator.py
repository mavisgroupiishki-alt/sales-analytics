...
def render_index(calls: List[Dict], stats: Dict, analyses: Dict, generated_at: str) -> str:
    ...
    period_tabs_html = (
        ...
        '<button class="period-tab active" data-period="day" type="button">Раб. день</button>'
    ...
    period_js = (
        ...
        'var now=new Date();'
        'var dow=now.getDay();'
        'var daysBack=(dow===1)?3:(dow===0)?2:(dow===6)?1:1;'
        'var prev=new Date(now);prev.setDate(prev.getDate()-daysBack);'
        'var yStart=new Date(prev.getFullYear(),prev.getMonth(),prev.getDate(),0,0,0);'
        'var yEnd=new Date(prev.getFullYear(),prev.getMonth(),prev.getDate(),23,59,59);'
